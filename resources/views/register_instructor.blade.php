...
@section('tituloPagina','Creación de Instructor')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header text-center">Registrar Instructor</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register.instructor') }}" id="registerForm">
                        @csrf
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        Swal.fire({
            title: '¡instructor Registrado con Éxito!',
            icon: 'success',
