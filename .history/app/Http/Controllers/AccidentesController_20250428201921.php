    ...
    public function edit($id)
{
    ...
    return view('accidentes.edit', compact('accidente', 'areas', 'lesiones', 'riesgos', 'tiposAccidente'));
}
    ...
    public function update(Request $request, $id)
{
    ...
    $accidente->fecha_hora = $request->input('fecha_hora');
    $accidente->area_unidad_productiva_id = $request->input('area_unidad_productiva_id');
    $accidente->tipo_lesion_id = $request->input('tipo_lesion_id');
    $accidente->tipo_riesgo_id = $request->input('tipo_riesgo_id');
    $accidente->tipo_accidente_id = $request->input('tipo_accidente_id');
    $accidente->descripcion = $request->input('descripcion');
    $accidente->evidencia = $request->input('evidencia');
    $accidente->gravedad = $request->input('gravedad');
    $accidente->save();
