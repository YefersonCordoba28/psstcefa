...
public function index()
    {
       $emergencias = Emergencia::with([
        ...
        // Puedes pasar los datos de las relaciones a la vista si es necesario
   ...
   public function store(Request $request)
{
    ...
    $request->validate([
        ...
        'evidencia' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048', // Validación para imágenes
...
if ($request->hasFile('evidencia')) {
    // Guardar la imagen directamente en public/emergencias
    $rutaImagen = $request->file('evidencia')->move(public_path('emergencias'), $request->file('evidencia')->getClientOriginalName());
    
    // Obtener solo el nombre del archivo para guardar en BD
    $nombreArchivo = $request->file('evidencia')->getClientOriginalName();
    $rutaImagen = 'emergencias/'.$nombreArchivo;
}
    ...
    Emergencia::create([
        ...
        'evidencia' => $rutaImagen, // Guardamos la ruta de la imagen
    ...
    {
        // Cargar la emergencia con sus relaciones
