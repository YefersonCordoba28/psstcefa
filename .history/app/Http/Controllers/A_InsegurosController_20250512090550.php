...
class A_InsegurosController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $inseguros->update($request->all());
            return redirect()->route('actos_inseguros.index')->with('success', 'Acto inseguro actualizado exitosamente.');
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Error al actualizar el acto inseguro: ' . $e->getMessage());
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('actos_inseguros.index')->with('success', 'Acto inseguro eliminado exitosamente.');
    }
}
