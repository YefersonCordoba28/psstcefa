...
Route::get('/tipo_accidentes/create', [TipoAccidenteController::class, 'create'])->name('tipo_accidentes.create');
Route::post('/tipo_accidentes/store', [TipoAccidenteController::class, 'store'])->name('tipo_accidentes.store');
