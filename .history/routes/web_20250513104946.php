...
use App\Http\Controllers\RespuestaEventossController;

// RUTA PARA VER TODAS LAS RESPUESTAS REGISTRADAS
Route::get('/respuestas', [RespuestaEventoController::class, 'index'])->name('respuestas.index');

// RUTA PARA MOSTRAR EL FORMULARIO DE REGISTRO DE UNA RESPUESTA NUEVA
Route::get('/respuestas/create', [RespuestaEventoController::class, 'create'])->name('respuestas.create');

// RUTA PARA GUARDAR UNA NUEVA RESPUESTA
Route::post('/respuestas', [RespuestaEventoController::class, 'store'])->name('respuestas.store');
