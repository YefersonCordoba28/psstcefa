...
use App\Http\Controllers\InseguridadesController;
...
Route::get('/emergencias/forminseguridades', [InseguridadesController::class, 'create'])->name('inseguridades.create');
Route::post('/incidentes/store', [InseguridadesController::class, 'store'])->name('inseguridades.store');
Route::get('/', [EmergenciasController::class, 'index'])->name('inseguridades.index');