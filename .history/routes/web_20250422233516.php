...
Route::delete('/cultivos/{id}',[TipoAccidentesController::class, 'destroy'])->name('tipo_accidentes.destroy');
Route::put('/cultivos/{id}',[TipoAccidentesController::class, 'update'])->name('tipo_accidentes.update');