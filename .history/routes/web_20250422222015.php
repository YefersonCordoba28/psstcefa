...
// Ruta para mostrar la vista con los tres formularios (GET)
Route::get('/tipos', [TipoController::class, 'index'])->name('tipos.index');

// Ruta para procesar el formulario de tipo_accidente (POST)
Route::post('/tipos/tipo-accidente', [TipoController::class, 'storeTipoAccidente'])->name('tipos.storeTipoAccidente');

// Ruta para procesar el formulario de tipo_lesion (POST)
Route::post('/tipos/tipo-lesion', [TipoController::class, 'storeTipoLesion'])->name('tipos.storeTipoLesion');

// Ruta para procesar el formulario de tipo_riesgo (POST)
