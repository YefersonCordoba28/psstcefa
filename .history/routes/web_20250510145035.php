...
use App\Http\Controllers\TipoActosInsegurosController;
Route::get('/tipo_actos_inseguros/create', [TipoActosInsegurosController::class, 'create'])->name('tipo_actos_inseguros.create');
Route::post('/tipo_actos_inseguros/store', [TipoActosInsegurosController::class, 'store'])->name('tipo_actos_inseguros.store');
Route::get('/tipo_actos_inseguros/lista_tipos_actos',[TipoActosInsegurosController::class, 'index'])->name('tipo_actos_inseguros.index');
Route::put('/tipo_actos_inseguros/{id}',[TipoActosInsegurosController::class, 'update'])->name('tipo_actos_inseguros.update');
Route::delete('/tipo_actos_inseguros/{id}',[TipoActosInsegurosController::class, 'destroy'])->name('tipo_actos_inseguros.destroy');