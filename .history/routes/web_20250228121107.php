...
Route::get('/Register-Admin', [RegisterMayordomoController::class, 'showForm'])->name('register.mayordomo.form');
Route::post('/Register-Admin', [RegisterMayordomoController::class, 'register'])->name('register.mayordomo');