...
Route::get('/emergencias/{id}',[EmergenciasController::class, 'show'])->name('emergencias.show');
Route::get('/emergencias/{id}/edit',[EmergenciasController::class, 'edit'])->name('emergencias.edit');
