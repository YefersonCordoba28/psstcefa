...
Route::get('/Register-Funcionario', [RegisterFuncionarioController::class, 'showForm'])->name('register.admin.form');
Route::post('/Register-Funcionario', [RegisterFuncionarioController::class, 'register'])->name('register.admin');