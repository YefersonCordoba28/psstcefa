...
Route::get('/Register-Route::get('/Register-Funcionario', [RegisterFuncionarioController::class, 'showForm'])->name('register.funcionario.form');
Route::post('/Register-Funcionario', [RegisterFuncionarioController::class, 'register'])->name('register.funcionario');', [RegisterFuncionarioController::class, 'showForm'])->name('register.funcionario.form');
Route::post('/Register-Funcionario', [RegisterFuncionarioController::class, 'register'])->name('register.funcionario');