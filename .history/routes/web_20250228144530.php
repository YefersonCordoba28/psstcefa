...
Route::get('/Register-Instructor', [RegisterFuncionarioController::class, 'showForm'])->name('register.funcionario.form');
Route::post('/Register-Instructor', [RegisterFuncionarioController::class, 'register'])->name('register.funcionario');