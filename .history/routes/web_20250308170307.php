...
Route::get('/emergencias/formemergencias', [EmergenciasController::class, 'create'])->name('incidentes.create');
Route::post('/incidentes/store', [EmergenciasController::class, 'store'])->name('incidentes.store');
Route::get('/', [EmergenciasController::class, 'index'])->name('incidentes.index');