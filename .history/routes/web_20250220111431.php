...
Route::get('/eventos/formeventos', [EventosController::class, 'create'])->name('cultivos.create');
Route::post('/cultivos/store', [EventosController::class, 'store'])->name('cultivos.store');