...
use App\Http\Controllers\Area_unidad_productivasController;

Route::get('/area_unidad_productivas/create', [Area_unidad_productivasController::class, 'create'])->name('area_unidad_productivas.create');
Route::post('/area_unidad_productivas/store', [Area_unidad_productivasController::class, 'store'])->name('area_unidad_productivas.store');