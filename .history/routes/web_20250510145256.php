...
Route::post('/tipo_actos_inseguros/store', [TipoaActosInsegurosController::class, 'store'])->name('tipo_actos_inseguros.store');
Route::get('/tipo_actos_inseguros/lista_tipos_actos',[TipoaActosInsegurosController::class, 'index'])->name('tipo_actos_inseguros.index');
