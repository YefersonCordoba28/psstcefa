...
use App\Http\Controllers\Accidentontroller;
...
Route::get('/accidentes/formaccidentes', [AcidentesController::class, 'create'])->name('accidentes.create');
Route::post('/accidentes/store', [AcidentesController::class, 'store'])->name('accidentes.store');
Route::get('/', [AcidentesController::class, 'index'])->name('accidentes.index');