...
use App\Http\Controllers\pruebasControler;
...
Route::get('/pruebas/index', [pruebasControler::class, 'index'])->name('xd');

Route::get('/pruebas/repuesta', [pruebasControler::class, 'historialReportes'])->name('prueba.respuesta');
