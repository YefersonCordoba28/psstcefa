...
@section('tituloPagina', 'Registro de Inseguridad')
                ...
                <form id="inseguridadForm" action="{{ route('inseguridades.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="area_productiva" id="area_productiva" class="form-control" placeholder="Ej: Unidad de Ganaderia" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="lugar_inseguridad" id="lugar_inseguridad" class="form-control" placeholder="Ej: Sala de ordeño #2" required>
                        </div>
                    </div>
