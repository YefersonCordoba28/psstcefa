...
<script>
    ...
    // Eventos con personas involucradas
    const eventos = {
    ...
    function mostrarDetalles() {
        ...
        if (evento) {
            ...
            for (let key in evento) {
                if (evento.hasOwnProperty(key) && key !== 'id' && key !== 'personas_involucradas') {
            ...
            if (tipo === 'accidente' && evento.personas_involucradas) {
                evento.personas_involucradas.forEach(persona => {
                    ...
                    tdNombre.textContent = nombreCompleto || 'Sin nombre completo';
                    
                    // Cargo - mostramos el nombre del cargo si está disponible
                    const tdCargo = document.createElement('td');
                    tdCargo.textContent = persona.cargo || 'No especificado';
                    
                    // Tipo (afectado, testigo, etc.)
                    const tdTipo = document.createElement('td');
                    tdTipo.textContent = persona.tipo || 'No especificado';
