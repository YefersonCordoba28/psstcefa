        ...
        if (evento) {
            ...
            for (let key in evento) {
                if (evento.hasOwnProperty(key) && key !== 'id') {
                    ...
                    // Convertir IDs a nombres cuando corresponda
                    if (key === 'area_unidad_productiva_id') {
                        const area = mapeoDatos.areas_unidades.find(a => a.id === evento[key]);
                        valor.textContent = area ? area.nombre : `ID ${evento[key]}`;
                    } 
                    else if (key === 'tipo_identificacion_lesion_id') {
                    ...
                    else if (key === 'tipo_emergencia_id') {
                    ...
                    else if (key === 'tipo_acto_inseguro_id') {
