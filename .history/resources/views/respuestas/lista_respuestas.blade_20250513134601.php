            ...
            <tbody>
                @forelse($respuestas as $respuesta)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('respuestas.show', $respuesta->id) }}" class="btn btn-sm btn-info">Ver</a>
                            <a href="{{ route('respuestas.edit', $respuesta->id) }}" class="btn btn-sm btn-warning">Editar</a>
