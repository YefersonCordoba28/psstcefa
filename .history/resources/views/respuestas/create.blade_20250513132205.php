...
<script>
    const mapeoDatos = {
        tipos_lesiones: @json($tipos_lesiones),
        tipos_riesgos: @json($tipos_riesgos),
        tipos_accidentes: @json($tipos_accidentes),
        tipos_incidentes: @json($tipos_incidentes),
        tipos_emergencias: @json($tipos_emergencias),
        tipos_acto_inseguro: @json($tipos_acto_inseguro),
        areas_unidades: @json($areas_unidades),
    };
</script>
@endsection