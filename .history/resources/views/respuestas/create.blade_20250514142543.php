...
<div class="container py-4">
    <div class="card shadow-lg border-0">
        <!-- Encabezado con colores SENA -->
        <div class="card-header text-white" style="background: linear-gradient(135deg, #39A900 0%, #006F1D 100%);">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="mb-0 opacity-75">Sistema de Gestión de Seguridad y Salud en el Trabajo - SENA</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body bg-light">
            <form action="{{ route('respuestas.store') }}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="card mb-4 border-0 shadow-sm">
                    <div class="card-header" style="background-color: #E0F7D2;">
                        <div class="d-flex align-items-center">
                            <i class="bi bi-search me-2" style="color: #39A900;"></i>
                            <h5 class="mb-0 fw-bold" style="color: #39A900;">Selección del Evento</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text text-white" style="background-color: #39A900;">
                ...
                <div class="card mb-4 shadow-sm border-0" id="tabla_detalles" style="display: none;">
                    <div class="card-header" style="background-color: #FFF3CD;">
                        <div class="d-flex align-items-center">
                            <i class="bi bi-info-circle me-2" style="color: #FF6B00;"></i>
                            <h5 class="mb-0 fw-bold" style="color: #FF6B00;">Detalles del Evento</h5>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-header" style="background-color: #D4EDDA;">
                        <div class="d-flex align-items-center">
                            <i class="bi bi-chat-square-text me-2" style="color: #39A900;"></i>
                            <h5 class="mb-0 fw-bold" style="color: #39A900;">Respuesta al Evento</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="mb-4">
                ...
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-header" style="background-color: #EAEAEA;">
                        <div class="d-flex align-items-center">
                            <i class="bi bi-person-badge me-2" style="color: #333333;"></i>
                            <h5 class="mb-0 fw-bold" style="color: #333333;">Información de Registro</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text text-white" style="background-color: #333333;">
                ...
                <div class="d-flex justify-content-between mt-4">
                    <button type="submit" class="btn text-white px-4 py-2" style="background: linear-gradient(135deg, #39A900 0%, #006F1D 100%);">
                        <i class="bi bi-save me-2"></i>Guardar Respuesta
                    </button>
                    <a href="{{ route('respuestas.index') }}" class="btn btn-outline-dark px-4 py-2">
...
/* Estilos generales */
    ...
    /* Estilos especiales para cada tipo de evento según colores SENA */
    .tipo-accidente { color: #FF6B00; } /* Naranja SENA para alertas altas */
    .tipo-incidente { color: #FFBE00; } /* Amarillo SENA para alertas medias */
    .tipo-emergencia { color: #FF0000; } /* Rojo para emergencias */
    .tipo-acto-inseguro { color: #333333; } /* Gris oscuro */
    ...
    /* Estilo SENA para logos y branding */
    .logo-sena {
        max-height: 40px;
    }
    
    /* Bordes verdes SENA para elementos destacados */
    .border-sena {
...
<script>
    ...
    // Colores para cada tipo de evento (adaptados a SENA)
    const coloresTipos = {
        accidente: "#FF6B00",      // Naranja SENA
        incidente: "#FFBE00",      // Amarillo SENA
        emergencia: "#FF0000",     // Rojo
        acto_inseguro: "#333333"   // Gris oscuro
    };
