    ...
    <div class="table table-responsive">
        <table class="table table-sm table-bordered">
            <thead>
                ...
                <th><center>Personas Involucradas</center></th>
        ...
        <div class="modal fade" id="editar" tabindex="-1" aria-labelledby="editarLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="formEditar" action="{{ route('eventos.update', 0) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tipo_evento" id="edit-tipo_evento" class="form-select" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="descripción_evento" id="edit-descripción_evento" rows="3" class="form-control"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="edit-personas_involucradas" class="form-label">Personas Involucradas</label>
                                <textarea name="personas_involucradas" id="edit-personas_involucradas" rows="2" class="form-control"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="edit-testigos" class="form-label">Testigos</label>
                                <textarea name="testigos" id="edit-testigos" rows="2" class="form-control"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="edit-evidencia" class="form-label">Evidencias</label>
                                <input type="file" name="evidencias" id="edit-evidencia" class="form-control" accept="image/*">
                            </div>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.editbtn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('edit-testigos').value = this.getAttribute('data-testigos');
