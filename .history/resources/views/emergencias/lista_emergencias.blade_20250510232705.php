...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Manejar la visualización de evidencias
            document.querySelectorAll('.preview-evidence').forEach(button => {
                button.addEventListener('click', function() {
    ...
    <style>
        ...
        /* Estilos para la visualización de evidencias */
        #evidenceImage {
            max-width: 100%;
