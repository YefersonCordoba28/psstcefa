...
@section('content')
                                    ...
                                    <tbody>
                                        @forelse ($emergencias as $emergencia)
                                            ...
                                            @if($emergencia->evidencia)
                                                <img src="{{ asset('emergencias/' . basename($emergencia->evidencia)) }}" 
                                                     alt="Evidencia" 
                                            ...
                                            @endif
                                                ...
                                                <td class="text-center align-middle" data-label="Acciones">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <button class="btn btn-success btn-sm editbtn w-100"
    ...
    <style>
        ...
        /* Asegurar que los botones mantengan el mismo tamaño en móviles */
        @media (max-width: 768px) {
            .evidence-img {
                max-width: 60px;
                max-height: 60px;
