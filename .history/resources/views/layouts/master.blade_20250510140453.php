...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <style>
    .welcome-wrapper {
        min-height: calc(100vh - 57px); /* Altura total menos navbar */
        display: flex;
        align-items: center;
        justify-content: center;
        background-color: #f4f6f9; /* color fondo AdminLTE */
        padding: 40px 20px;
    }
...
<div class="welcome-wrapper">
    <div class="welcome-box">
        ...
        <p>
            Este sistema está diseñado para facilitar la gestión de eventos relacionados con la seguridad y salud en el trabajo, permitiendo registrar, analizar y generar informes de manera eficiente.
        </p>
    </div>
</div>
