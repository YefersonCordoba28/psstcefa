...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-header bg-lightblue">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Bienvenido al Sistema de Seguridad y Salud en el Trabajo</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Card to contain content dynamically -->
...
<style>
    /* Custom Styling */
    .content-header.bg-lightblue {
        background-color: #e0f7fa; /* Soft light blue */
        padding: 20px 0;
        border-bottom: 2px solid #0097a7; /* Adding a border to separate */
    }
    ...
    .card-header {
        background-color: #0277bd; /* Deep blue for header */
    ...
    /* Add some hover effects to cards for interactivity */
    .card:hover {
    ...
    .content-header h1 {
        font-size: 2rem;
        color: #00796b; /* Slightly dark green to keep it professional */
    }
</style>
