...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Sistema de Seguridad y Salud en el Trabajo</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <!-- Integración con Admilite -->
    <script src="https://cdn.admilite.com/sdk/v1/admilite.js"></script>
</head>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div class="text-center md:text-left md:w-1/2">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <button id="loginBtn" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg transition duration-300">
                        Iniciar Sesión
                    </button>
                    <button class="border border-blue-600 text-blue-600 hover:bg-blue-50 font-medium py-2 px-6 rounded-lg transition duration-300">
                        Más Información
                    </button>
                </div>
            </div>
            
            <!-- Imagen ilustrativa (puedes reemplazar con tu propia imagen) -->
            <div class="md:w-1/2">
