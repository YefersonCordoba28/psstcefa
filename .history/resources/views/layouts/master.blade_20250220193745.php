            ...
            <form id="eventoForm" action="{{ route('eventos.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text" style="background-color: #007BFF; color: white;"><i class="bi bi-calendar-date"></i></span>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text" style="background-color: #007BFF; color: white;"><i class="bi bi-clock"></i></span>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text" style="background-color: #007BFF; color: white;"><i class="bi bi-geo-alt"></i></span>
