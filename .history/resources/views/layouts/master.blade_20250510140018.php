...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="row mb-4">
        <div class="col-lg-12 text-center">
            <h1 class="display-4 font-weight-bold text-primary">Bienvenido al Sistema de Seguridad y Salud en el Trabajo</h1>
            <p class="lead text-muted">Gestione eventos, prevenga riesgos y garantice el bienestar en su entorno laboral.</p>
        </div>
    </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card bg-info text-white h-100 shadow">
                <div class="card-body d-flex align-items-center">
                    <i class="fas fa-helmet-safety fa-3x mr-3"></i>
                    <div>
                        <h5 class="card-title">Registro de Eventos</h5>
                        <p class="card-text">Accidentes, incidentes, emergencias y actos inseguros.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-success text-white h-100 shadow">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="card-text">Visualización y gestión de factores críticos.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-warning text-white h-100 shadow">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="card-text">Ubicación de eventos reportados en el centro.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-primary text-white h-100 shadow">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="card-text">Acceda a reportes y estadísticas personalizadas.</p>
                    </div>
                </div>
            </div>
        </div>
