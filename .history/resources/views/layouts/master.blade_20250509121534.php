...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <li class="nav-item has-treeview menu-open">
        ...
        <!-- Submenú: Registro de Tipos -->
        <ul class="nav nav-treeview pl-3">
            <li class="nav-header">Registro de Tipos</li>
        ...
        <!-- Submenú: Registro de Cargos -->
        <ul class="nav nav-treeview pl-3">
            <li class="nav-header">Registro de Cargos</li>
            <li class="nav-item">
