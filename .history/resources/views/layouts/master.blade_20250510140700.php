...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- CONTENIDO PRINCIPAL -->
<main class="pt-4 pb-16 min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-100 to-white">
    <div class="max-w-6xl w-full mx-4 md:mx-8 grid md:grid-cols-2 gap-10 items-center">
        
        <!-- Texto de bienvenida -->
        <div class="space-y-6">
            <h1 class="text-4xl font-extrabold text-gray-800 leading-tight">
                Bienvenido al <span class="text-orange-500">Sistema de Seguridad y Salud</span> en el Trabajo
            </h1>
            <p class="text-lg text-gray-600">
                Esta plataforma permite gestionar, registrar y analizar los eventos relacionados con la seguridad y salud laboral, promoviendo un entorno seguro y eficiente para todos los colaboradores.
            </p>
            <div class="flex flex-wrap gap-4">
                <a href="#" class="inline-flex items-center gap-2 px-6 py-3 bg-orange-500 text-white rounded-md font-medium hover:bg-orange-600 transition">
                    <i class="bi bi-journal-text"></i> Ver Reportes
                </a>
                <a href="#" class="inline-flex items-center gap-2 px-6 py-3 border border-orange-500 text-orange-600 rounded-md font-medium hover:bg-orange-100 transition">
        ...
        <div class="relative">
            <div class="rounded-xl overflow-hidden shadow-lg ring-1 ring-orange-300">
                <img src="{{ asset('images/carrusel1.jpg') }}" alt="Seguridad laboral" class="w-full h-auto object-cover">
            </div>
            <div class="absolute bottom-3 left-3 bg-white bg-opacity-90 text-gray-700 px-4 py-2 rounded-lg text-sm shadow">
                Comprometidos con el bienestar en el entorno laboral.
            </div>
        </div>
    </div>
</main>
