                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('register.funcionario.form') }}" class="nav-link">
                                    <i class="fas fa-list nav-icon"></i>
                                    <p>Registre Funcionario</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('register.instructor.form') }}" class="nav-link">
                                    <i class="fas fa-list nav-icon"></i>
                                    <p>Registre Instructor</p>
                                </a>
                            </li>
