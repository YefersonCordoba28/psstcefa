...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
       <style>
    .welcome-section {
        min-height: calc(100vh - 57px); /* Ajuste según el alto del navbar */
...
<div class="welcome-section">
    <div class="container">
        <h1>Bienvenido al Sistema de Seguridad y Salud en el Trabajo</h1>
        <p>Monitorea, gestiona y reporta eventos para un entorno laboral más seguro y eficiente.</p>

        <div class="row card-group-home mt-5">
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card bg-light text-dark shadow info-card h-100">
                    <div class="card-body text-center">
                        <i class="fas fa-clipboard-list fa-3x text-primary mb-3"></i>
                        <h5 class="card-title">Registro de Eventos</h5>
                        <p class="card-text">Documenta accidentes, incidentes y emergencias fácilmente.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card bg-light text-dark shadow info-card h-100">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title">Análisis de Riesgos</h5>
                        <p class="card-text">Evalúa y visualiza patrones de riesgo laboral.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card bg-light text-dark shadow info-card h-100">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title">Referencias Geográficas</h5>
                        <p class="card-text">Ubicación precisa de los eventos reportados.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card bg-light text-dark shadow info-card h-100">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title">Informes SST</h5>
                        <p class="card-text">Consulta y genera reportes personalizados.</p>
                    </div>
                </div>
            </div>
        </div>
