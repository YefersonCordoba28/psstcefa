...
@section('content')
<div class="container d-flex justify-content-center align-items-center" style="height: 100vh; background: #f4f6f9;">
    <div class="card shadow-lg border-0" style="width: 420px; border-radius: 12px;">
        ...
        <img src="{{ asset('images/por.png') }}" alt="Logotipo SST" width="80" height="80"> 
         <h4 class="mt-2"><i class="fas fa-hard-hat"></i> Inicia Sesion</h4>
