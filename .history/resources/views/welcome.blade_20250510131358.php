...
<!-- Header con diseño limpio y profesional, reemplazando azul por naranja -->
<header class="fixed top-0 w-full bg-white text-gray-800 shadow-sm z-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
    ...
    <div class="flex items-center gap-4">
      ...
      <div>
        <h1 class="text-xl md:text-2xl font-semibold text-gray-800 leading-tight tracking-tight">Sistema de Gestión SST</h1>
      </div>
    </div>

    <!-- Menú hamburguesa para móviles -->
    <button id="menu-toggle" class="md:hidden text-3xl focus:outline-none text-gray-600 hover:text-[#f97316] transition-colors">
    ...
    <nav id="menu" class="hidden md:flex flex-col md:flex-row md:items-center gap-4 text-sm font-medium absolute md:static top-16 right-4 bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:p-0 rounded-lg md:rounded-none transition-all duration-300 ease-in-out">
      <a href="#" class="relative text-gray-600 hover:text-[#f97316] transition-colors duration-300">Login</a>
      <a href="#" class="relative text-gray-600 hover:text-[#f97316] transition-colors duration-300">Reportes</a>
      <a href="#" class="relative text-gray-600 hover:text-[#f97316] transition-colors duration-300">Contacto</a>
      <a href="#" class="inline-flex items-center px-4 py-2 bg-[#f97316] text-white rounded-lg font-medium hover:bg-[#ea580c] transition-colors duration-300">
        Acceso
      </a>
    </nav>
  </div>
