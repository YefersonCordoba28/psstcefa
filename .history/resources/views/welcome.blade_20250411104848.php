    ...
    <section class="bg-white py-16">
      <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center">
        <h3 class="text-3xl md:text-4xl font-bold text-gray-800 mb-12">
          Nuestro impacto en seguridad y salud
        </h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div class="flex flex-col items-center">
            <i class="bi bi-people-fill text-5xl text-orange-500 mb-4"></i>
            <h4 class="text-2xl font-semibold text-gray-700">+5.000</h4>
            <p class="text-gray-600 mt-2">Usuarios activos del sistema</p>
          </div>
          <div class="flex flex-col items-center">
            <i class="bi bi-shield-check text-5xl text-orange-500 mb-4"></i>
            <h4 class="text-2xl font-semibold text-gray-700">98%</h4>
            <p class="text-gray-600 mt-2">Incidentes gestionados con éxito</p>
          </div>
          <div class="flex flex-col items-center">
            <i class="bi bi-bar-chart-line text-5xl text-orange-500 mb-4"></i>
            <h4 class="text-2xl font-semibold text-gray-700">+120</h4>
            <p class="text-gray-600 mt-2">Reportes generados mensualmente</p>
          </div>
        </div>
      </div>
    </section>
