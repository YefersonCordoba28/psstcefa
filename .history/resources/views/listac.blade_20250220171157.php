        ...
        <table class="table table-sm table-bordered">
            ...
            <tbody>
                @foreach ($datos as $item)
                    <tr>
                        <td><center>{{ $ite->id }}</center></td>
                        <td><center>{{ $ite->fecha }}</center></td>
                        <td><center>{{ $ite->hora }}</center></td>
                        <td><center>{{ $ite->ubicación }}</center></td>
                        <td><center>{{ $ite->tipo_evento }}</center></td>
                        <td><center>{{ $ite->descripción_evento }}</center></td>
                        <td>
