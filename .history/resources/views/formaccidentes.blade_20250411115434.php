    ...
    <div class="w-full max-w-4xl bg-white shadow-2xl rounded-2xl border border-blue-200 overflow-hidden">
        ...
        <form id="accidenteForm" action="{{ route('accidentes.store') }}" method="POST" enctype="multipart/form-data" class="bg-gray-50 px-8 py-10 space-y-6">
            ...
            <div class="text-center pt-6">
                <button type="submit"
    class="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white text-lg font-bold px-10 py-4 rounded-xl shadow-lg transform hover:scale-105 transition duration-300 ease-in-out flex items-center justify-center space-x-2">
