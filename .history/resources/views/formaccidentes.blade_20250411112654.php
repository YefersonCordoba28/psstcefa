...
<div id="preview-container" class="mt-4 hidden">
    <p class="text-blue-900 font-semibold mb-2">Vista previa:</p>
    <img id="preview-image" src="#" alt="Vista previa"
        class="w-32 h-32 object-cover rounded-lg border border-blue-300 shadow-md">
</div>
