        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        {{-- Buscador --}}
                        <form method="GET" action="{{ route('personas_involucradas.index') }}" class="mb-3">
                            <div class="input-group">
                                <input type="text" name="busqueda" class="form-control" placeholder="Buscar por nombre o apellido..." value="{{ request('busqueda') }}">
                                ...
                                <tbody>
                                    @forelse($personas as $persona)
                                        <tr>
                                            ...
                                            <td>
                                                @if($persona->accidente)
                                                    {{ $persona->accidente->id }} - {{ \Illuminate\Support\Str::limit($persona->accidente->descripcion, 30) }}
                                                @else
                                                    N/A
                                                @endif
                                            </td>
