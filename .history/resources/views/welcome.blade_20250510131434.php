...
<!-- Header profesional con un diseño suave y atractivo en azul oscuro -->
<header class="fixed top-0 w-full bg-[#1F2A44] text-white shadow-md z-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
    ...
    <!-- Menú principal -->
    <nav id="menu" class="hidden md:flex flex-col md:flex-row md:items-center gap-4 md:gap-6 text-sm font-medium absolute md:static top-20 right-4 bg-[#1F2A44] md:bg-transparent shadow-md md:shadow-none p-4 md:p-0 rounded-md md:rounded-none transition-all duration-300 ease-in-out">
      @if (Route::has('login'))
        <a class="relative text-white hover:text-blue-300 transition-colors duration-300 hover:underline underline-offset-4" href="{{ route('login') }}">{{ __('Login') }}</a>
      @endif
      <a href="#" class="relative text-white hover:text-blue-300 transition-colors duration-300 hover:underline underline-offset-4">Reportes</a>
      <a href="#" class="relative text-white hover:text-blue-300 transition-colors duration-300 hover:underline underline-offset-4">Contacto</a>
    </nav>
  </div>
</header>
