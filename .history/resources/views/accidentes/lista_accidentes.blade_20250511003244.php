                                            ...
                                            <tr class="accidente-row" data-gravedad="{{ $accidente->gravedad }}">
                                                ...
                                                <td class="text-center align-middle" data-label="Evidencias">
                                                    @if($accidente->evidencia)
                                                        <div class="evidence-container" style="display: inline-block;">
                                                            <img src="{{ asset('img_accidentes/' . $accidente->evidencia) }}" 
                                                                 alt="Evidencia del accidente" 
                                                                 class="evidence-img"
                                                                 style="width: 80px; height: 80px; object-fit: cover; cursor: pointer; transition: transform 0.3s; border-radius: 4px; border: 1px solid #ddd;">
                                                        </div>
                                                    @else
