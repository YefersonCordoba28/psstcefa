...
<div class="container py-4">
    <div class="card shadow-lg border-0 rounded-lg">
        ...
        <div class="card-body p-4">
            @if(session('success'))
                <div class="alert alert-success alert-dismissible fade show shadow-sm border-start border-success border-4 animate__animated animate__fadeInDown" role="alert">
                    <div class="d-flex align-items-center">
                        <div class="bg-success bg-opacity-25 p-2 me-3 rounded-circle">
                            <i class="fas fa-check-circle text-success fa-lg"></i>
                        </div>
                        <div>
                            <h5 class="alert-heading mb-1">¡Accidente registrado con éxito!</h5>
                        ...
                        <div class="p-3 bg-light rounded-3 mb-4">
                            ...
                            <div class="card mb-3 border-dashed">
                                <div class="card-body text-center p-3">
                                    ...
                                    <p class="small text-muted mb-2">Arrastre una imagen o haga clic para seleccionar</p>
            ...
            <div class="modal-content border-0 shadow">
                <div class="modal-body p-0">
                    <div class="bg-success text-white text-center py-4 position-relative">
                        ...
                        <div class="rounded-circle bg-white mx-auto d-flex align-items-center justify-content-center" style="width: 80px; height: 80px;">
                            <i class="fas fa-check-circle text-success fa-4x"></i>
                        </div>
                    </div>
                    <div class="p-4 text-center">
                        <h4 class="mb-3">¡Accidente registrado con éxito!</h4>
                        <p class="text-muted mb-4">La información ha sido guardada correctamente en el sistema.</p>
                        <div class="d-grid gap-2 col-8 mx-auto">
                            <button type="button" class="btn btn-primary py-2" data-bs-dismiss="modal">Aceptar</button>
                            <a href="{{ route('accidentes.index') }}" class="btn btn-outline-secondary py-2">Ver registro</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    document.getElementById('accidenteForm').addEventListener('submit', function(e) {
        ...
        if (!isValid) {
            ...
            // Si todo es válido, mostrar modal de éxito al enviar (simulación)
            // Nota: En un caso real, esto se manejaría después de enviar el formulario
            // Esto es solo para visualización en la demo
