                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body p-4">
                            ...
                            <td class="text-center align-middle" data-label="Evidencias">
    @if($accidente->evidencia)
        <div class="evidence-thumbnail" style="width: 80px; height: 80px; margin: 0 auto; cursor: pointer;" 
             data-bs-toggle="modal" data-bs-target="#imageModal" 
             data-img-src="{{ asset('img_accidentes/' . $accidente->evidencia) }}">
            <img src="{{ asset('img_accidentes/' . $accidente->evidencia) }}" 
                 alt="Evidencia del accidente" 
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-0">
                <img id="modalImage" src="" alt="Evidencia completa" class="img-fluid">
            </div>
