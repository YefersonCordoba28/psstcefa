...
@section('content')
   ...
   <!-- Modal (con animaciones, igual que antes) -->
<div class="modal fade" id="modalPersonalizado" tabindex="-1" aria-labelledby="modalPersonalizadoLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <form id="formPersona" action="{{ route('personas_involucradas.store') }}" method="POST">
                @csrf
...
<!-- ✅ Alerta flotante -->
<div id="successAlert" class="alert alert-success alert-dismissible fade" role="alert" style="position: fixed; top: 20px; right: 20px; z-index: 1055;">
    <i class="fas fa-check-circle me-2"></i>
    ¡Persona registrada con éxito!
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Cerrar"></button>
</div>

<!-- ✅ JS para mostrar alerta después del cierre del modal -->
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (e) {
            ...
            // Simular envío y cierre
            setTimeout(() => {
                const bsModal = bootstrap.Modal.getInstance(modal);
                bsModal.hide();

                // Mostrar alerta después del cierre
                setTimeout(() => {
