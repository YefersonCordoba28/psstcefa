        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-center bg-dark text-white">
                            ...
                            <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modalPersonalizado">
                                Ver Detalles
                            </button>
                        </div>
            ...
            <div class="modal fade" id="modalPersonalizado" tabindex="-1" aria-labelledby="modalPersonalizadoLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        @include('personas_involucradas.create') {{-- Este archivo debe estar en resources/views/partials/modal-content.blade.php --}}
                    </div>
                </div>
            </div>
