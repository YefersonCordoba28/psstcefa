...
<div class="container py-4">
    <div class="card shadow border-0">
        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-">
            <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Registrar Accidente</h5>
            <a href="{{ route('accidentes.index') }}" class="btn btn-outline-light btn-sm">
                <i class="fas fa-list me-1"></i> Ver Lista de Accidentes
            </a>
        </div>
        <div class="card-body">
            @if(session('success'))
