                                ...
                                <table class="table table-bordered table-hover table-striped align-middle" id="accidentesTable">
                                    <thead class="thead-dark bg-dark text-white">
                                        <tr>
                                            ...
                                            <th class="text-center d-none d-md-table-cell" data-label="Tipo de lesión">Tipo de lesión</th>
                                            <th class="text-center d-none d-md-table-cell" data-label="Tipo de riesgo">Tipo de riesgo</th>
                                            <th class="text-center d-none d-md-table-cell" data-label="Tipo de accidente">Tipo de accidente</th>
                                    ...
                                    <tbody>
                                        @forelse ($accidentes as $accidente)
                                            <tr class="accidente-row" data-gravedad="{{ $accidente->gravedad }}">
                                                ...
                                                <td class="align-middle text-center d-none d-md-table-cell" data-label="Tipo de lesión">{{ $accidente->tipoLesion->nombre ?? 'N/A' }}</td>
                                                <td class="align-middle text-center d-none d-md-table-cell" data-label="Tipo de riesgo">{{ $accidente->tipoRiesgo->nombre ?? 'N/A' }}</td>
                                                <td class="align-middle text-center d-none d-md-table-cell" data-label="Tipo de accidente">{{ $accidente->tipoAccidente->nombre ?? 'N/A' }}</td>
