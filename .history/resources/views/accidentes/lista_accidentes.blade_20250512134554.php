...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-center bg-dark text-white">
                            <h5 class="card-title m-0 mb-2 mb-md-0">Accidentes Registrados</h5>
                            <div class="d-flex flex-wrap gap-2">
                                <a href="{{ route('accidentes.create') }}" class="btn btn-primary btn-sm mb-2 mb-md-0">
                                    <i class="fas fa-plus me-1 d-none d-md-inline"></i>Registrar Nuevo
                                </a>
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalPersonalizado">
                                    <i class="fas fa-user-plus me-1 d-none d-md-inline"></i>Registrar Persona
                                </button>
                            </div>
                        </div>
                        <div class="card-body p-3 p-md-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-8 col-lg-6">
                                    <form id="searchForm" class="mb-3 mb-md-0">
                                        <div class="input-group">
                                            ...
                                            <button type="button" id="resetFilter" class="btn btn-secondary btn-sm">
                                                <i class="fas fa-undo"></i> <span class="d-none d-md-inline">Resetear</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped align-middle" id="accidentesTable">
                                    <thead class="thead-dark bg-dark text-white">
                                        <tr>
                                            <th class="text-center" data-label="ID">ID</th>
                                            <th class="text-center" data-label="Fecha">Fecha</th>
                                            <th class="text-center d-none d-sm-table-cell" data-label="Área">Área</th>
                                            <th class="text-center d-none d-md-table-cell" data-label="Lesión">Lesión</th>
                                            <th class="text-center d-none d-lg-table-cell" data-label="Riesgo">Riesgo</th>
                                            <th class="text-center d-none d-lg-table-cell" data-label="Accidente">Accidente</th>
                                    ...
                                    <tbody>
                                        @forelse ($accidentes as $accidente)
                                            <tr class="accidente-row" data-gravedad="{{ $accidente->gravedad }}">
                                                <td class="text-center align-middle" data-label="ID">{{ $accidente->id }}</td>
                                                <td class="align-middle text-center" data-label="Fecha">{{ date('d/m/Y', strtotime($accidente->fecha_hora)) }}</td>
                                                <td class="align-middle text-center d-none d-sm-table-cell" data-label="Área">{{ $accidente->areaUnidadProductiva->nombre ?? 'N/A' }}</td>
                                                <td class="align-middle text-center d-none d-md-table-cell" data-label="Lesión">{{ $accidente->tipoLesion->nombre ?? 'N/A' }}</td>
                                                <td class="align-middle text-center d-none d-lg-table-cell" data-label="Riesgo">{{ $accidente->tipoRiesgo->nombre ?? 'N/A' }}</td>
                                                <td class="align-middle text-center d-none d-lg-table-cell" data-label="Accidente">{{ $accidente->tipoAccidente->nombre ?? 'N/A' }}</td>
                                                ...
                                                <td class="text-center align-middle" data-label="Acciones">
                                                    <div class="d-flex flex-wrap justify-content-center gap-1">
                                                        <button class="btn btn-success btn-sm editbtn action-btn mb-1"
                                                        ...
                                                        <button class="btn btn-danger btn-sm deletebtn action-btn mb-1"
                                                                data-id="{{ $accidente->id }}"
                                                                data-bs-toggle="modal"
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content border-0 shadow-lg rounded-4">
                        <form action="{{ route('personas_involucradas.store') }}" method="POST">
                            ...
                            <div class="modal-body py-4 px-3 px-md-4">
                                <div class="row g-3">
                                    <!-- Nombre -->
                            ...
                            <div class="modal-footer bg-light rounded-bottom-4 d-flex justify-content-between px-3 px-md-4 py-3">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg rounded-4">
                        <form id="eliminarForm" method="POST">
                            ...
                            <div class="modal-body py-4 px-3 px-md-4 text-center">
                                <div class="mb-4">
                            ...
                            <div class="modal-footer bg-light rounded-bottom-4 d-flex justify-content-center px-3 px-md-4 py-3">
    ...
    <style>
        ...
        @media (max-width: 767.98px) {
            ...
            /* Mostrar etiquetas de datos en móviles */
            .table td[data-label] {
                position: relative;
                padding-left: 50%;
                text-align: right;
            ...
            /* Ajustar el zoom de imágenes en móviles */
            .evidence-img {
        ...
        @media (min-width: 768px) and (max-width: 991.98px) {
            /* Ocultar algunas columnas en tablets */
            .d-none-tablet {
                display: none !important;
            }
