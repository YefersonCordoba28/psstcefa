    ...
    <div class="card shadow border-0">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('accidentes.store') }}" method="POST">
                ...
                {{-- Fecha y hora --}}
                <div class="mb-4">
                    <label for="fecha_hora" class="form-label fw-semibold"><i class="fas fa-calendar-alt me-1"></i>Fecha y Hora del Accidente</label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label for="area_unidad_productiva_id" class="form-label fw-semibold"><i class="fas fa-industry me-1"></i>Área o Unidad Productiva</label>
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="tipo_lesion_id" class="form-label fw-semibold"><i class="fas fa-hand-holding-medical me-1"></i>Tipo de Lesión</label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label for="tipo_riesgo_id" class="form-label fw-semibold"><i class="fas fa-exclamation-triangle me-1"></i>Tipo de Riesgo</label>
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="tipo_accidente_id" class="form-label fw-semibold"><i class="fas fa-ambulance me-1"></i>Tipo de Accidente</label>
                ...
                {{-- Descripción --}}
                <div class="mb-4">
                    <label for="descripcion" class="form-label fw-semibold"><i class="fas fa-align-left me-1"></i>Descripción</label>
                    <textarea name="descripcion" class="form-control" rows="3" placeholder="Describa el accidente...">{{ old('descripcion') }}</textarea>
                </div>

                {{-- Evidencia --}}
                <div class="mb-4">
                    <label for="evidencia" class="form-label fw-semibold"><i class="fas fa-paperclip me-1"></i>Evidencia</label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label for="gravedad" class="form-label fw-semibold"><i class="fas fa-thermometer-half me-1"></i>Gravedad</label>
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="creado_por" class="form-label fw-semibold"><i class="fas fa-user-edit me-1"></i>Creado por</label>
