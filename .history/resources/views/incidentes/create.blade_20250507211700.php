        ...
        <div class="card-body">
            ...
            <form action="{{ route('incidentes.store') }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="descripcion" class="form-control" rows="3" placeholder="Describa el incidente...">{{ old('descripcion') }}</textarea>
                </div>
                ...
                {{-- Nivel de riesgo y Creado por --}}
                <div class="row g-3 mt-3">
                    <div class="col-12 col-md-6">
                        <label for="nivel_riesgo" class="form-label fw-semibold">
                            <i class="fas fa-thermometer-half me-1"></i>Nivel de Riesgo
                        </label>
