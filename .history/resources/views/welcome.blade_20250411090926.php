...
<head>
    ...
    <!-- Font: Arial (default system font, similar to OIT) -->
    <style>
        :root {
        ...
        * {
        ...
        /* Carousel (Hidden in this design, but included for your structure) */
        .carousel-container {
            display: none; /* OIT design doesn't show a carousel in the hero */
        }
...
<body>
    ...
    <main>
        <section class="hero">
            ...
            <!-- Carousel (Hidden but included for your structure) -->
