...
<body>
  ...
  <div class="content">
    <h3>Certificaciones Vigentes 2022</h3>
    <p>El Ministerio de Ambiente y Desarrollo Sostenible certifica nuevamente sus Sistemas de Gestión:</p>
    <ul>
    ...
    <div id="carouselCertificaciones" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://via.placeholder.com/800x400?text=Certificación+1" class="d-block w-100" alt="Certificación 1">
        </div>
        <div class="carousel-item">
          <img src="https://via.placeholder.com/800x400?text=Certificación+2" class="d-block w-100" alt="Certificación 2">
        </div>
        <div class="carousel-item">
          <img src="https://via.placeholder.com/800x400?text=Certificación+3" class="d-block w-100" alt="Certificación 3">
        </div>
      </div>
