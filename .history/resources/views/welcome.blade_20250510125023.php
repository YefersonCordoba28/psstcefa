...
<!-- Header profesional en degradado naranja -->
<header class="fixed top-0 w-full bg-gradient-to-r from-orange-500 via-orange-400 to-orange-500 text-white shadow-xl z-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
    ...
    <div class="flex items-center gap-4">
      ...
      <div>
        <h1 class="text-xl md:text-2xl font-bold leading-tight tracking-wide">Sistema de Gestión SST</h1>
    ...
    <!-- Menú principal -->
    <nav id="menu" class="hidden md:flex flex-col md:flex-row md:items-center gap-4 md:gap-6 text-sm font-medium absolute md:static top-20 right-4 bg-orange-500 md:bg-transparent shadow md:shadow-none p-4 md:p-0 rounded-md md:rounded-none transition-all duration-300 ease-in-out">
      @if (Route::has('login'))
        <a class="hover:underline underline-offset-4" href="{{ route('login') }}">{{ __('Login') }}</a>
      @endif
      <a href="#" class="hover:underline underline-offset-4">Reportes</a>
      <a href="#" class="hover:underline underline-offset-4">Contacto</a>
    </nav>
  </div>
</header>
