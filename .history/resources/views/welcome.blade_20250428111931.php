...
<body class="bg-gray-50 text-gray-800">
  ...
  <!-- Main -->
  <main class="relative pt-28 pb-24 bg-gradient-to-br from-white via-gray-100 to-white">
    <div class="absolute inset-0 pointer-events-none">
      <svg class="absolute top-0 left-0 w-64 md:w-80 h-64 md:h-80 opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <circle fill="#fb923c" cx="100" cy="100" r="100"/>
      </svg>
      <svg class="absolute bottom-0 right-0 w-48 md:w-64 h-48 md:h-64 opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
