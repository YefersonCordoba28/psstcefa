  ...
  <div class="content">
    ...
    <div id="carouselCertificaciones" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <center>  <img src="{{ asset('images/logo.png') }}" class="d-block w-10" alt="lal">
        </div>
        <div class="carousel-item">
        <center>  <img src="{{ asset('images/carrusel1.jpg') }}" class="d-block w-50" alt="Certificación 2">  </center>
        </div>
        <div class="carousel-item">
