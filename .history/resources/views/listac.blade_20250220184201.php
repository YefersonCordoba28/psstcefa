            ...
            <tbody>
                @foreach ($datos as $item)
                    <tr>
                        ...
                        <td>
                            <center><button type="button" class="btn btn-success editbtn" data-id="{{ $item->id }}" data-fecha="{{ $item->fecha }}" data-hora="{{ $item->hora }}" data-ubicación="{{ $evento->ubicación }}" data-tipo_evento="{{ $evento->tipo_evento }}" data-descripción_evento="{{ $item->descripción_evento }}" data-bs-toggle="modal" data-bs-target="#editar">Editar</button></center>
                        </td>
                        <td>
